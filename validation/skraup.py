...
def main() -> None:
    ...
    print("   the whole difference and it is worth more than 160 kJ/mol in dH.")
    ...
    print("   flask is heated -- it just has 725 kJ/mol to spend doing it, and")
    ...
    print(f"      quinoline {tot0[QUINOLINE]:.6e} mol -- the flask does nothing,")
    print("      which is the correct answer for a Skraup.")
    print()
