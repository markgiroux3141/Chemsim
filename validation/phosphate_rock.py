...
cations = sorted({i for _n, m in blocked for i in m if "-" not in i})
print(f"  Blocked on the SULFIDE ion: {len(sulfide)}. When C2 wrote this panel it")
print("  was five of five, the same shape phosphate was -- `_PAIRS` carried")
print("  H2S -> [SH-] at pKa 7.00 and stopped there, because a polyprotic acid")
print("  gets entered as far as somebody needed and nothing checks that the")
print("  chain is finished.")
print()
print("  T12 finished this one, and NOT by picking inside the 12.9-to-19 spread")
print("  C2 refused to pick inside. `ion_data` carries [SH-] and [S-2] on one")
print("  CRC basis, so their difference IS the dissociation Gibbs energy and the")
print("  pKa is 12.91 by subtraction -- the same operation this module makes to")
print("  get a Ksp. Taking a modern 17-19 instead would have priced [S-2] twice,")
print("  once here and once against the five sulfide lattices below.")
print()
print(f"  What is left blocked is a CATION: {cations}. That is the spectator")
print("  zero rather than a missing pKa, so it is a different repair.")
