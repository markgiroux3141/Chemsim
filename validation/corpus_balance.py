...
def main() -> int:
    ...
    print("   this row, found that, and REFUSED it -- naming the missing product")
    print("   would be inventing chemistry inside the corpus, which is the")
    print("   `diels-alder-route` precedent this file already follows.")
    print()
